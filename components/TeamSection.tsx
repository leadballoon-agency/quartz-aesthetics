    ...
    <section id="team" className="py-12 sm:py-16 md:py-24 bg-gradient-to-b from-white to-primary-50">
      <div className="max-w-7xl mx-auto section-padding">
        <div className="text-center mb-6 sm:mb-8 lg:mb-10">
          <span className="text-primary-600 font-medium tracking-wider uppercase text-xs sm:text-sm">HIFU Experts</span>
          ...
          <p className="text-sm sm:text-base leading-relaxed text-neutral-600 mt-2 sm:mt-3 max-w-2xl mx-auto px-4">
            Expert practitioners in advanced aesthetics & HIFU treatments
          </p>
        </div>
                ...
                <div className="space-y-2 sm:space-y-3">
                  ...
                  <ul className="grid grid-cols-1 gap-1.5 sm:gap-2">
                    {member.qualifications.map((qual, idx) => (
                      <li key={idx} className="flex items-start sm:items-center text-sm text-neutral-700">
                        <svg className="w-4 h-4 text-primary-500 mr-2 flex-shrink-0 mt-0.5 sm:mt-0" fill="currentColor" viewBox="0 0 20 20">
